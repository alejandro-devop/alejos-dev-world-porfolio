const THEME_INIT = `(function(){try{var k="theme",r=document.documentElement,s=localStorage.getItem(k),d=s==="dark"||(s==="system"?window.matchMedia("(prefers-color-scheme: dark)").matches:s!=="light");r.classList.toggle("dark",d);r.style.colorScheme=d?"dark":"light"}catch(e){}})();`;
 ...
 * Sync with ThemeProvider: storageKey "theme", defaultTheme "dark".
 */
